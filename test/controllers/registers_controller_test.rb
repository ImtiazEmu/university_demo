...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { semester_no: @register.semester_no, student_id_card: @register.student_id_card, subject_name: @register.subject_name }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { semester_no: @register.semester_no, student_id_card: @register.student_id_card, subject_name: @register.subject_name }
    assert_redirected_to register_path(assigns(:register))
  end
